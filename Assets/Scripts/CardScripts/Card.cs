...
namespace QGAMES
{
    ...
    public class Card : MonoBehaviour
    {
        ...
        public void getTickMark()
        {
            int count = transform.childCount;
            GameObject tick = transform.GetChild(0).gameObject;
            Transform outerBorder = tick.transform.GetChild(0);
            outerBorder.GetComponent<SpriteRenderer>().color = new Color(126, 80, 80, 126); ;           
